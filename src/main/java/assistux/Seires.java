...
public class Seires {
	...
	public void serie2() {
		...
		inpt3.setEditable(false);	//crea el dialogo
		inpt3.setBounds(10, espacio, 180, 20);
		espacio-=30;
		JTextField inpt2 = new JTextField();
	...
	public void serie3() {
		JTextField inpt2 = new JTextField();
		inpt2.setText("Watchmen, deberias verla.");
		inpt2.setEditable(false);	//crea el dialogo
		inpt2.setBounds(10, espacio, 200, 20);
		espacio-=30;
		JTextField inpt = new JTextField();
	...
	public void serie4() {
		...
		espacio-=30;
		JTextField inpt2 = new JTextField();
		inpt2.setText("Si es de mas 200 deberias ver");
		inpt2.setEditable(false);	//crea el dialogo
		inpt2.setBounds(10, espacio, 200, 20);
		espacio-=30;
		JTextField inpt = new JTextField();
	...
	public void serie5() {
		JTextField inpt2 = new JTextField();
		inpt2.setText("'Black Mirror' asi que debe ser buena");
		inpt2.setEditable(false);	//crea el dialogo
